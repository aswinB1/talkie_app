...
await Firebase.initializeApp(
  ...
  runApp(ChangeNotifierProvider(create:(context) => Darkmode(), child:const MyApp()));
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Flutter Demo',
      theme: ThemeData(brightness: Provider.of<Darkmode>(context).Bmode,
